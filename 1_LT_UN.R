...
# The UN life tables are for single years of age. In addition, they end at age 100 and we need the open age group 80+ ( to be coherent with healthy prevalences)
# So, first we calculate mortality rates for the age group 80+ and then applying the "life.table" function to recalculate 
# other life table's functions.
# Once we have calculated Life tables for single years of age, we calculated the abridged ones.
...
# closing at age 90 (Alternative open age interval)
